...
```{r eval = FALSE, ranges_boxplot_mean_model_selection, fig.width = 3, fig.height = 3, fig.cap = "Width of 95% CIs across 125 simulations for the homogeneous model, the heterogeneous model, and model selection."}
...
```{r eval = FALSE, error12, fig.width = 3, fig.height = 3.5, fig.cap = "Difference between median estimate and true value of mean proliferation rate for the homogeneous, heterogeneous and model selection, across 125 simulations."}
